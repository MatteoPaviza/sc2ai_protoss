...
# from sc2_manager.base import Base
...
#         prefered_base = self.sorted_by_distance_to(worker)[0]
#         prefered_base.add_worker(worker)
...
#     def sorted_by_distance_to(self, position: Union[Base, Unit, Point2], reverse: bool = False) -> List[Base]:
...
#         self[0].build_additional_pylons(1)